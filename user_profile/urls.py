...
from user_profile.views import profile, upload_photo, add_achievement, add_certificate, view_trial_application_details, \
    delete_trial_application, delete_certificate, delete_achievement, download_application, update_application
...
urlpatterns = [
    ...
    url(r'^update_trial_information/(?P<_id>\d+)/$', update_application, name="update_application")
]
